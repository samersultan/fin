 ...
 *
 */
function fin_cleanup_canonical() {
	global $wp_the_query;
...
add_action('init', 'fin_cleanup_canonical');
 ...
 */
function fin_root_relative_url($input) {
 ...
 */
function fin_fix_duplicate_subfolder_urls($input) {
  $output = fin_root_relative_url($input);
...
add_filters($root_rel_filters, 'fin_root_relative_url');
add_filter('script_loader_src', 'fin_fix_duplicate_subfolder_urls');
add_filter('style_loader_src', 'fin_fix_duplicate_subfolder_urls');
 ...
 */
function fin_remove_default_description($bloginfo) {
  $default_tagline = 'Just another WordPress site';

  return ($bloginfo === $default_tagline) ? '' : $bloginfo;
}
add_filter('get_bloginfo_rss', 'fin_remove_default_description');
