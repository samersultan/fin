...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<dl class="address">
		<dt class="left"><?php echo $title; ?></dt>
		<a href="<?php echo esc_url( add_query_arg('address', $name, get_permalink(woocommerce_get_page_id( 'edit_address' ) ) ) ); ?>" class="edit button tiny secondary"><i class="icon-pencil"></i> <?php _e( 'edit', 'woocommerce' ); ?></a>
		<?php	$address = array(
