...
<form id="cart" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
...
<?php do_action( 'woocommerce_before_cart_table' ); ?>
	...
	<div class="cart-actions">
		...
		<div class="form-actions">
			<input type="submit" class="update-button button" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>"><input type="submit" class="checkout-button button" name="proceed" value="<?php _e( 'Checkout', 'woocommerce' ); ?>">
		</div>
